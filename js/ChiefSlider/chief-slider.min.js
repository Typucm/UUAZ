...
function ChiefSlider(t, i) {
    ...
    for (var s in this._$root = e,
        ...
        this._minOrder = 0, this._maxOrder = 0, this._$itemWithMinOrder = null,
        ...
        this._config = { loop: !0, autoplay: !1, interval: 5e3, refresh: !0, swipe: !0 }, i)
    ...
    for (var h = 0, _ = r.length; h < _; h++)r[h].dataset.index = h,
        r[h].dataset.order = h,
...
ChiefSlider.prototype._addEventListener = function () {
    ...
    function r(t) {
        if (this._hasSwipeState) {
            ...
            e > 50 ? (this._direction = "next", this._move()) : e < -50 && (this._direction = "prev", this._move()),
    ...
    t.addEventListener("click", function (t) {
        ...
        t.addEventListener("mouseenter", function (t) { this._autoplay("stop") }.bind(this)),
        t.addEventListener("mouseleave", function (t) { this._autoplay() }.bind(this)),
        e.refresh && window.addEventListener("resize", function () { window.requestAnimationFrame(this._refresh.bind(this)) }.bind(this)),
        e.loop && (i.addEventListener("transition-start", function () { this._balancingItemsFlag || (this._balancingItemsFlag = !0, window.requestAnimationFrame(this._balancingItems.bind(this))) }.bind(this)),
            i.addEventListener("transitionend", function () { this._balancingItemsFlag = !1 }.bind(this))),
        e.swipe && (t.addEventListener("touchstart", s.bind(this)), t.addEventListener("mousedown", s.bind(this)),
            document.addEventListener("touchend", r.bind(this)), document.addEventListener("mouseup", r.bind(this))),
        t.addEventListener("dragstart", function (t) { t.preventDefault() }.bind(this)),
        document.addEventListener("visibilitychange",
            function () { "hidden" === document.visibilityState ? this._autoplay("stop") : "visible" === document.visibilityState && this._config.loop && this._autoplay() }.bind(this))
},
